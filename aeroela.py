...
cy_per = [[] for _ in range(constants.mode_num)]
cy_deg = [[] for _ in range(constants.mode_num)]
len_ar = [[] for _ in range(constants.mode_num)]
al_deg = [[] for _ in range(constants.mode_num)]
al_per = [[] for _ in range(constants.mode_num)]
cx_per = [[] for _ in range(constants.mode_num)]
cx_val = [[] for _ in range(constants.mode_num)]
xf_per = [[] for _ in range(constants.mode_num)]
xf_val = [[] for _ in range(constants.mode_num)]
